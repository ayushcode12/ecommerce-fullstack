...
function Navbar({ cartCount }) {
  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-[var(--border)] bg-white/85 backdrop-blur-xl">
      <div className="mx-auto flex w-full max-w-[1600px] flex-col gap-3 px-4 py-4 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between md:px-6 lg:px-8">
        <Link
          to="/"
          className="font-display text-xl font-bold tracking-tight text-slate-900 md:text-2xl"
        >
        ...
        <div className="flex w-full flex-wrap items-center gap-2 sm:w-auto sm:gap-3 md:gap-4">
          ...
          <Link
            to="/"
            className="order-2 rounded-xl p-2 text-slate-600 transition hover:bg-slate-100 hover:text-teal-700 sm:order-none"
          >
            <Home size={22} />
          </Link>
          ...
          <Link
            to="/cart"
            className="relative order-2 rounded-xl p-2 text-slate-600 transition hover:bg-slate-100 hover:text-teal-700 sm:order-none"
          >
